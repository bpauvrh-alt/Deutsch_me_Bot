...
from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup, FSInputFile, Update
...
async def on_startup():
    ...
    old_webhook = await bot.get_webhook_info()
    if old_webhook.url:
        print(f"Удаляем старый webhook: {old_webhook.url}")
